...
If you're mouse still refuses to lock in the center or stop lagging the game, try using gamescope: `PULSE_LATENCY_MSEC=60 gamescope -f -W 1920 -H 1080 --force-grab-cursor -- [Rest of the launch options]`
